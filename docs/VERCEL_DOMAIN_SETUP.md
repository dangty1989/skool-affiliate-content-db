...
- **Domain mong muốn:** `skool-affiliate-content-db.vercel.app` ⏳ (đang cấu hình)
...
# Test domain mới (nếu đã add)
curl -I https://skool-affiliate-content-db.vercel.app

# Test domain đang hoạt động
curl -I https://skool-machine.vercel.app
